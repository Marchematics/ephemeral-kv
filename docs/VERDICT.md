...
| C7 | the cost law moves routing at a quality-admissible state, including a hotspot | **134/624** replay cells advance, **52 of them at the 8,192 state where both metrics hold**, covering balanced, slow-worker and worker-loss; a hotspot variant (one worker at a tenth of the service rate) advances in all three regimes (16/48 cells) | the balanced, hotspot and slow-worker wins are the no-cluster-KV-store regime with a warm cache holding a fraction of the fleet |
