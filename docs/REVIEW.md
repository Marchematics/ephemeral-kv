...
| "54 cells at a quality-admissible state (52 at 8,192 across balanced, hotspot, slow-worker and worker-loss, 2 at 16,384), every one of them clearing the 1.5x goodput bar" | `g4-quality-join-v2.json`, `g4-all-phase-summary-v2.json` |
